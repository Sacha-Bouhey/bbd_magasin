...
-- Listage des données de la table magasin.fournir : ~6 rows (environ)
DELETE FROM `fournir`;
...
-- Listage des données de la table magasin.produit : ~5 rows (environ)
DELETE FROM `produit`;
...
-- Listage des données de la table magasin.stocker : ~4 rows (environ)
DELETE FROM `stocker`;
